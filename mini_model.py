...
#we performed sanity checks here to make sure the untransformations worked
...
#HERE were performed sanity checks to ensure if we set learning rate to 0, the vectors were not modified and BERT
#stil printed correctly (to verify the validity of our split architecture)
