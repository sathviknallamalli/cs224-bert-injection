...
#text =  "the author next to the security guards " + tokenizer.mask_token + " after the event ended"
text = "The blacksmith tempered the sword with the " + tokenizer.mask_token + " ."
